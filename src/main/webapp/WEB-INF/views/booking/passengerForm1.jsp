			...
			if (passenNum > 1) {
				...
				$.ajax({
					...
					success: function(response) {
						...
						window.location.href = 'insertPassen1?passenNum='+ passenNum;
						//$('#passenNum').val(newPassenNum);
					},
 ...
 <div id="reservForm1">
	...
	<div class="timeInfo-wrapper">
		...
		<h4>
					...
					<h4>
					&nbsp; &nbsp;
						 <strong> 승객${(passenNum1 != null) ? passenNum1 : passenNum}&nbsp;명
				...
				<div id="form-wrapper">	
							<div id="reservForm">	<!-- 0711 -->
								...
								<div id="passenForm2" class="passenForm" style="margin-top: 20px;">
									...
									<span>
										<input type="radio" id="gender" name="gender" value="F" size="30" style="width:40px;height:40px;font-size:14pt;
										...
										<b style="vertical-align: middle;display: inline-block; margin-bottom: 32px;color:#5d5f61;">남성</b>
									</span>
								</div>
								<br><br>
							<div id="buttons">
