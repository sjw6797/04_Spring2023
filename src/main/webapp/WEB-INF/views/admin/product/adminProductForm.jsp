...
<article>
	...
	<form name="frm" method="post" action="insertProduct">
		<table class="adminTable">
			...
			<tr>
				...
				<td style="text-align: left;">
					<input type="text" name="category" id="search" list="searchOptions" class="content-input" style="width: 100%;"/>
			...
			<tr>
				...
				<td style="text-align: left;">
					...
					<div id="content" style="font-size: 130%;width: 800px; min-height: 400px; border: 1px solid #dcdcdc; overflow-y: auto;" contenteditable="true"></div>
		...
		<input type="submit" class="input_button" value="작성하기" style="background: rgb(0, 37, 108); float: right;" onclick="return productCheck('${countryList}')">
	...
	<form name="fromm" id="fileupForm" method="post" enctype="multipart/form-data">
		<input type="file" name="fileimage"><input type="button" id="myButton" value="추가하기">&nbsp;<input type="button" id="myButton1" value="타이틀 이미지">
	</form>
	</div>
</article>
